                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                    ...
                    <div className="relative order-first lg:order-last">
                        <div className="bg-gray-100 rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg h-[300px] sm:h-[400px] lg:h-[500px] relative">
                            ...
                            <div className="absolute top-4 left-4 sm:top-8 sm:left-8 bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg max-w-[160px] sm:max-w-[200px]">
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-a-green-600/10 rounded-full flex items-center justify-center">
                                        <span className="text-xs font-bold text-a-green-600">S</span>
                                    </div>
                        ...
                        <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl border border-gray-100">
                            <div className="flex items-center gap-2 sm:gap-3">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-a-green-600/10 rounded-lg sm:rounded-xl flex items-center justify-center">
                                    <ThumbsUp size={20} className="sm:w-6 sm:h-6 text-a-green-600" />
                                </div>
                                <div>
                    ...
                    <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            <div className="inline-flex items-center bg-a-green-600/10 text-a-green-600 px-3 py-1 rounded-full text-xs font-medium">
                                <span className="w-1.5 h-1.5 bg-a-green-600 rounded-full mr-2 animate-pulse"></span>
                                Customer Reviews
                            </div>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">
                                <span className="text-gray-900">What Our</span>
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-a-green-600 to-a-green-600"> Customers Say</span>
                            </h2>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
                                <div className="flex items-center gap-2 sm:gap-3">
                                    <div className="flex -space-x-1 sm:-space-x-2">
                                        {[
                                            { name: "Sarah", color: "bg-a-green-600" },
                        ...
                        <div className="pt-4 flex items-center justify-center md:justify-start">
                            <button className="group bg-gradient-to-r from-a-green-600 to-a-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center gap-3">
                                Write a Review
