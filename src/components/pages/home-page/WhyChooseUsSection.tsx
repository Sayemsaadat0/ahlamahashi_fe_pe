...
const WhyChooseUsSection = () => {
    const features = [
        {
            ...
            color: "bg-a-green-600/10 text-a-green-600",
    ...
    return (
        <section className="bg-gradient-to-br fade-top-mask from-gray-50 to-white py-12 md:py-20">
            <div className="ah-container mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-a-green-600 to-a-green-600"> Choice</span>
                    </h2>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                    {stats.map((stat, index) => (
                        <div key={index} className="text-center p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
                            <div className="text-2xl md:text-3xl font-bold text-a-green-600 mb-2">
                                {stat.number}
                            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    {features.map((feature, index) => (
                        ...
                        >
                            {/* Background Pattern */}
                            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-a-green-600/5 to-transparent rounded-full -translate-y-10 translate-x-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            ...
                            <div className="relative z-10">
                                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-a-green-600 transition-colors duration-300">
                                    {feature.title}
                                </h3>
                                ...
                                {/* Highlight Badge */}
                                <div className="inline-flex items-center gap-2 text-sm font-medium text-a-green-600">
                                    <CheckCircle size={16} />
                                    {feature.highlight}
                                </div>
                            </div>
                ...
                <div className="text-center">
                    <div className="bg-gradient-to-r from-a-green-600 to-a-green-600 rounded-3xl p-8 text-white relative overflow-hidden">
                        {/* Background Pattern */}
                        ...
                        <div className="relative z-10">
                            ...
                            <button className="bg-white text-a-green-600 px-8 py-3 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-1 shadow-lg">
                                Start Ordering Now
                            </button>
                        </div>
                    </div>
