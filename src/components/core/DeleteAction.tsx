...
const DeleteAction: React.FC<DeleteActionProps> = ({
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent className="bg-white text-black w-[300px] p-6">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <Button
              ...
              className="flex-1 rounded-full  cursor-pointer bg-black/10 hover:bg-black/20 text-black border border-white/20"
            >
              Cancel
            </Button>
            <Button
